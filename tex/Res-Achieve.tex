...
%\vspace{-10pt}
%	\centering
%		\subfloat[\#ACCs=6]{\includegraphics[width=.48\linewidth]{fig/MAARoop6.pdf}\label{fig:oop6}}
%		\hfill
%		\subfloat[\#ACCs=12]{\includegraphics[width=.48\linewidth]{fig/MAARoop12.pdf}\label{fig:oop12}}
%		\\
%		\vspace{-8pt}
%		\subfloat[\#ACCs=19]{\includegraphics[width=.48\linewidth]{fig/MAARoop19.pdf}\label{fig:oop19}}
%		\hfill
%		\subfloat[\#ACCs=12]{\includegraphics[width=.48\linewidth]{fig/MAARoop12all.pdf}\label{fig:oop12all}}
%		\vspace{-8pt}
